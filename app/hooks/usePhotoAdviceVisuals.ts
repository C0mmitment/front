...
> = {
  ...
  'up-left': { dx: -8, dy: -8, rotation: '-135deg', position: { top: '2%', left: 8 } },
  'up-right': { dx: 8, dy: -8, rotation: '-45deg', position: { top: '2%', right: 8 } },
  'down-left': { dx: -8, dy: 8, rotation: '135deg', position: { bottom: '2%', left: 8 } },
  'down-right': { dx: 8, dy: 8, rotation: '45deg', position: { bottom: '2%', right: 8 } },
  forward: {
    dx: 0,
    dy: 0,
    isDepth: true,
